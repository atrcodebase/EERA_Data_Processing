...
write.xlsx(clean_data.tool6_for_client_ulabeled, paste0(output_data_path, "cleaned_dfs/cleaned_data/Tool6_EERA_Public_School_Parent_Tool_Public_School_Unlabeled_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool7_for_client_ulabeled, paste0(output_data_path, "cleaned_dfs/cleaned_data/Tool7_EERA_Public_School_Shura_Tool_Public_School_Unlabeled_", Sys.Date(),".xlsx"))
...
write.xlsx(clean_data.tool6_for_client, paste0(output_data_path, "cleaned_dfs/for_client/Tool6_EERA_Public_School_Parent_Tool_Public_School_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool7_for_client, paste0(output_data_path, "cleaned_dfs/for_client/Tool7_EERA_Public_School_Shura_Tool_Public_School_", Sys.Date(),".xlsx"))
