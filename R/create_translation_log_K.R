...
need_translation <- c(
  ...
  # Tool 1:
  # "A31_Other", 
  "Interviewee_Respondent_Type_Other", "B6_Other", "B7_Other", "B7_1", "B7_2", "B9_Other", 
  "C2_Other", "C4_Other", "C4_1_Other", "C9_Other", "C12A3_Other", "C13A3_Other",
  ...
  # "E23_Other", "E24_Other", "E26_Other", "E27_Other", "F10_Other", "F15_Other", 
  "F16", 
  # "F17_Other", 
  "H2_Other", "H3_Other", "I7_Other", "I8_Other", "J2_Other", 
  # "J3_Other", "J4_Other",
  "J5_Other", "J7_Other", "J9_Other", "J10_Other", "J13_Other", "J15_Other", "J17_Other", "J19_Other", "J21_Other", 
  # "J22_Other", 
  "K3_Other", "K4_Other", "Survey_Language_Other",
  # "F14",
  "A28",
  
  # Tool 2:
  "B2", "Interviewee_Respondent_Type_Other", "C7_Other", "C8_Other", "C8_1", "C8_2", "C11_Other", "D2_Other",
  "D4_Other", "D4_1_Other", "D10_2_Other", "H5_Other", "H8_Other", "H11_Other",
  "H14_Other", "i5_Other", "i8_Other", "i11_Other", "i14_Other", "J5_Other", "J8_Other", "J11_Other", 
  "J14_Other", "Survey_Language_Other",
  
  # Tool 3:
  "Interviewee_Respondent_Type_Other", "B2_Other", "B3", "B4A1", "B4A2", "B10A1",
  "B10A3_Other", "B10A4", "C2_Other", "C5_Other", "C7_Other", "Survey_Language_Other","C10", 

  # Tool 4:
  "B2", "D1_Other", "D3_Other", "D5_Other", "D6_Other", "D6_IP_Name", "D9_Other", 
  "E27_Other", "F2_Subject_Name", "F5_Other", "F13_Other", "F16_Other", "F17_Other", 
  "G2_Other", "G3_Other", "G6_Other", "H5_Other", "H7_Other", "Survey_Language_Other",
  
  # Tool 5:
  "Interviewee_Respondent_Type_Other", "C7_Other", "Survey_Language_Other", "B2",

  # Tool 6:
  "A2", "B5_Other", "D3_Other", "D4_Other", "D5_Subject_Name", "D10_Other",
  "D11_Other", "D13_Other", "D14_Other", "E3_Other", "F2_Other", "F4_Other", "F5_Other",
  "F13_2_Other", "F13_3_Other", "Survey_Language_Other",
  
  # Tool 7:
  "B2", "B6_Other", "C0_Other", "C2_1_Other", "C2_2_Other", "C3_Other", "C4_Other", "C5_Other", "C8_Other", 
  "C9_Other", "C11_Other", "C12_Other", "C14_Other","C14_A", "C19_Other", "C23_Other", "C25_Other",
  "C27_Other", "E2_Other", "E3_Other",  "E4_Subject_Name", "E9_Other", "E10_Other",
  "E12_Other", "E13_Other", "F2_Other", "G2_Other", "Survey_Language_Other",
...
un_logged_values <- plyr::rbind.fill(
  ...
  ## Tool 1
  plyr::rbind.fill(
    log_translation_cols(clean_data.tool1$data |> select(-C10) |> mutate(across(all_of(c("E2_Other", "E10_Other")) , as.character)), need_translation) |> mutate(Tab_Name = "data"),
  ...
  ## Tool 2
  plyr::rbind.fill(
    log_translation_cols(clean_data.tool2$data |> select(-C10, - B3), need_translation) |> mutate(Tab_Name = "data"),
  ...
  ## Tool 4
  plyr::rbind.fill(
    log_translation_cols(clean_data.tool4$dat |> select(-F16) |> mutate(across(all_of(c("E2_Other", "E10_Other")) , as.character)), need_translation) |> mutate(Tab_Name = "data"),
  ...
  ## Tool 6
  plyr::rbind.fill(
    log_translation_cols(clean_data.tool6$data |> select(-F9, -B3), need_translation) |> mutate(Tab_Name = "data"),
