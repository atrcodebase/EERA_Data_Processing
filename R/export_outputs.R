...
write.xlsx(clean_data.tool1, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool1_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool2, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool2_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool3, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool3_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool4, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool4_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool5, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool5_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool6, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool6_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool7, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool7_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool8, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool8_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool9, paste0(output_data_path, "cleaned_dfs/unsterilized/cleaned_data_tool9_", Sys.Date(),".xlsx"))


# Exporting for client version of clean datasets -------------------------------
write.xlsx(clean_data.tool1_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool1_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool2_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool2_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool3_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool3_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool4_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool4_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool5_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool5_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool6_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool6_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool7_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool7_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool8_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool8_", Sys.Date(),".xlsx"))
write.xlsx(clean_data.tool9_for_client, paste0(output_data_path, "cleaned_dfs/for_client/cleaned_data_tool9_", Sys.Date(),".xlsx"))
