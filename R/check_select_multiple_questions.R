...
sm_check_result <- rbind(
  # Tool 1
  rbind(
    check_select_multiple(clean_data.tool1$data, multi_vars_tool_1, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool1$School_Operationality, multi_vars_tool_1, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool1$School_Operationality_Other_..., multi_vars_tool_1, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool1$Shifts_Detail, multi_vars_tool_1, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool1$Other_Shifts_Detail, multi_vars_tool_1, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool1$Headmasters, multi_vars_tool_1, question_separator="_", choice_seprator = " ")
  ) |>
    mutate(tool = "Tool 1 - Headmaster", Sample_Type = "Public School"),

  # Tool 2
  rbind(
    check_select_multiple(clean_data.tool2$data, multi_vars_tool_2, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool2$Public_Stationary_Kit_Group, multi_vars_tool_2, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool2$Teachers_Pack_Group, multi_vars_tool_2, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool2$Students_Pack_Group, multi_vars_tool_2, question_separator="_", choice_seprator = " ")
  ) |> 
  ...
  # Tool 4
  rbind(
    check_select_multiple(clean_data.tool4$data, multi_vars_tool_4, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool4$Subjects_Not_Being_Taught, multi_vars_tool_4, question_separator="_", choice_seprator = " ")
  ) |> 
  ...
  check_select_multiple(clean_data.tool6$data, multi_vars_tool_6, question_separator="_", choice_seprator = " ") |> 
    ...
    mutate(tool = "Tool 6 - Parent", .before = "Sample_Type"),
  ...
  # Tool 8
  rbind(
    check_select_multiple(clean_data.tool8$data, multi_vars_tool_8, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool8$Classes, multi_vars_tool_8, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool8$Classroom_Materials, multi_vars_tool_8, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool8$Teacher_Kit, multi_vars_tool_8, question_separator="_", choice_seprator = " "),
    check_select_multiple(clean_data.tool8$Student_Kit, multi_vars_tool_8, question_separator="_", choice_seprator = " ")
  ) |> 
...
# check if the PARENT multiple choice question is inconsistent with it's CHILD/BINARY questions
sm_na_issues <- rbind(
  # Tool 1
  rbind(
